-- @description CSW v1.3 Low Latency Auto Legato
-- @author Harry Brokensha
-- @version 0.1
-- @changelog
--  + init

-- hb_Apply Cinematic Studio Woodwinds v1.3 Low Latency legato transitions (based on note velocity, leaving note-on of first note and note-off of last note)
...
-- CSW v1.3 Low Latency legato transitions offsets:----
med_offset = -90 --ms
fast_offset = -70 --ms
-------------------------------------------------
...
function main()
  ...
  reaper.Undo_EndBlock("CSW v1.3 Low Latency Legato transitions: Move events", -1)
