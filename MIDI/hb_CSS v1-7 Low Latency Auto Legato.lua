-- @description CSS v1.7 Low Latency Auto Legato
-- @author Harry Brokensha
-- @version 0.1
-- @changelog
--  + init

-- hb_Apply Cinematic Studio Strings v1.7 Low Latency legato transitions (based on note velocity, leaving note-on of first note and note-off of last note)
...
-- CSS v1.7 Low Latency legato transitions offsets:----
med_offset = -250 --ms
fast_offset = -180 --ms
-------------------------------------------------
...
function main()
  ...
  reaper.Undo_EndBlock("CSS v1.7 Low Latency Legato transitions: Move events", -1)
