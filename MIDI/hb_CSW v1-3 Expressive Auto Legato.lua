-- @description CSW v1.3 Expressive Auto Legato
-- @author Harry Brokensha
-- @version 0.1
-- @changelog
--  + init

-- hb_Apply Cinematic Studio Woodwinds v1.3 Expressive legato transitions (based on note velocity, leaving note-on of first note and note-off of last note)
...
-- CSW v1.3 Expressive legato transitions offsets:----
slow_offset = -220 --ms
med_offset = -130 --ms
fast_offset = -90 --ms
-------------------------------------------------
...
function main()
  ...
  reaper.Undo_EndBlock("CSW v1.3 Expressive Legato transitions: Move events", -1)
