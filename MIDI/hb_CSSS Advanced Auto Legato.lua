-- @description CSSS Advanced Auto Legato
-- @author Harry Brokensha
-- @version 0.1
-- @changelog
--  + init

-- hb_Apply Cinematic Studio Solo Strings Advanced legato transitions (based on note velocity, leaving note-on of first note and note-off of last note)
...
-- CSSS Advanced legato transitions offsets:----
slow_offset = -333 --ms
med_offset = -250 --ms
fast_offset = -150 --ms
-------------------------------------------------
...
function main()
  ...
  reaper.Undo_EndBlock("CSSS Advanced Legato transitions: Move events", -1)
